	...
	$("#tiedot").validate({
		...
		messages: {
			nimi: {
				...
				minlength: "Syöttämäsi arvo on liian lyhyt"
			},
			merkkimalli: {
			...
			pituus: {
				...
				number: "Syötä arvo numeraalisessa muodossa",
				minlength: "Syöttämäsi arvo on liian pieni",
				maxlength: "Syöttämäsi arvo on liian suuri"
			},
			leveys: {
